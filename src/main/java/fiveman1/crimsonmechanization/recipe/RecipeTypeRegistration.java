...
public class RecipeTypeRegistration {
    ...
    public static final ResourceLocation ALLOYER_RECIPE_ID = new ResourceLocation(CrimsonMechanization.MODID, "alloyer");
    ...
    public static final BaseRecipeType<AlloyerRecipe> ALLOYER_RECIPE_TYPE = new BaseRecipeType<>(ALLOYER_RECIPE_ID);
