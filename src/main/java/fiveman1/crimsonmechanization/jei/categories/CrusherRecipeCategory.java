...
public class CrusherRecipeCategory implements IRecipeCategory<CrusherRecipeWrapper> {
    ...
    public CrusherRecipeCategory(IGuiHelper guiHelper) {
        ResourceLocation location = new ResourceLocation(CrimsonMechanization.MODID, "textures/gui/" + ModBlocks.blockCrusher.getName() + ".png");
    ...
    public String getUid() {
        return JEIPluginCrimsonMechanization.CRUSHER_ID;
    }

    @Override
    public String getTitle() {
        return I18n.format("category." + CrimsonMechanization.MODID + ".crusher");
    }
